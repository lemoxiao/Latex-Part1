...
\documentclass[a4paper,12pt,customfont,print,custombib,custommargin,twoside]{Classes/PhDThesisPSnPDF}
% yup
% ******************************************************************************
% ******************************* Class Options ********************************
...
\begin{figure}[H]
\centering
\hspace*{-0.9cm}\includegraphics[width=1.1\linewidth]{thesisdissertation.pdf}
\end{figure}

\include{Copyright/copyright}
\include{Declaration/originality}
...
\bibliographystyle{References/besjournals}
%\bibliographystyle{plainnat} % use this to have URLs listed in References
\cleardoublepage
\bibliography{References/library-thesis} % Path to your References.bib file
