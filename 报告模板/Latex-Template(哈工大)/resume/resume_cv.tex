...
\name{冯云龙}{}
\address{马头镇，太康县，周口市，河南，中国 461415}
\mobile{(+86) 18846155227}

\email{alongwyforever@gmail.com}
\homepage{alongwy.top}
\github{alongwy}
% \linkedin{posquit0}
%\skype{skypeid}
...
\makecvfooter{\today}{Yunlong Feng {\enskip\cdotp\enskip} Resume}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
