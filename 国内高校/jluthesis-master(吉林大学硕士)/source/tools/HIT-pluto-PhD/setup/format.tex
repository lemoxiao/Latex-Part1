...
\def\makecover{
    ...
    \ifxueweidoctor \def\xueweishort{博} \fi
    \ifxueweimaster \def\xueweishort{硕} \fi
...
%%%%%%增加一空白页
  \newpage
    ...
    \begin{center} {  Dissertation for the {\exueweier}  Degree in Engineering}\end{center} }
